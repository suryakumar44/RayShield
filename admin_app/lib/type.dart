...
class _TypesState extends State<Types> {
  ...
  Future<void> insert() async {
    if (skintypeController.text.isEmpty) return;
    try {
      final type = skintypeController.text;
      await supabase.from('tbl_type').insert({'type_name': type});
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Skin Type Inserted Successfully"),
  ...
  void showEditDialog(Map<String, dynamic> typeData) {
    TextEditingController editController = TextEditingController(
      text: typeData['type_name'],
    );
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: "Enter skin type (e.g. Oily, Dry)",
